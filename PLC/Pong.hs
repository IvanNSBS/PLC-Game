module Main where
    ...
    main = do
      ...
      funInit winConfig gameMap [bar,ball] () initScore input gameCycle (Timer 16) bmpList
    
    createBall :: PongObject
    createBall = 
      let ballPic = Basic(Circle 3.0 0.0 1.0 0.0 Filled)
    ...
    createBar = 
      ...
      in object "bar" barPi False (125,30) (0,0) ()             
